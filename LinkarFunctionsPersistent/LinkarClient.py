...
class LinkarClient:
	...
	def Select(self, filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions=LinkarFunctions.SelectOptions(), outputFormat=LinkarFunctions.DATAFORMATCRU_TYPE.MV, customVars="", receiveTimeout=0):
		opArgs = OperationArguments.OperationArguments.GetSelectArgs(filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions, customVars)
	...
	def Subroutine(self, subroutineName, argsNumber, args, inputFormat=LinkarFunctions.DATAFORMAT_TYPE.MV, outputFormat=LinkarFunctions.DATAFORMAT_TYPE.MV, customVars="", receiveTimeout=0):
		...
		result = linkar.LkExecutePersistentOperation(self.ConnectionInfo, opCode, opArgs, inputFormat, outputFormat, receiveTimeout)
	...
	"""
		...
		Returns:
			...
			The results of the operation.
	"""
	def Conversion(self, expression, code, conversionType, outputFormat=LinkarFunctions.DATAFORMAT_TYPE.MV, customVars="", receiveTimeout=0):
	...
	def GetVersion(self, outputFormat=LinkarFunctions.DATAFORMAT_TYPE.MV, receiveTimeout=0):
		...
		inputFormat = LinkarFunctions.DATAFORMAT_TYPE.MV
		return linkar.LkExecutePersistentOperation(this.ConnectionInfo, opCode, opArgs, inputFormat, outputFormat, receiveTimeout)
	...
	"""
		...
		Remarks:
			...
			By default:
				...
				VT - char (11) for rows.
	"""
	def LkProperties(self, filename, lkPropertiesOptions=LinkarFunctions.LkPropertiesOptions(),	outputFormat=LinkarFunctions.DATAFORMATSCH_TYPE.MV, customVars="", receiveTimeout=0):
	...
	def GetTable(self, filename, selectClause="", dictClause="", sortClause="", tableOptions=LinkarFunctions.TableOptions(), customVars="", receiveTimeout=0):
		...
		inputFormat = LinkarFunctions.DATAFORMATSCH_TYPE.TABLE
		return linkar.LkExecutePersistentOperation(self.ConnectionInfo, opCode, opArgs, inputFormat, outputFormat, receiveTimeout)
