...
class LinkarClient:
	...
	"""
		...
		--- Code
			...
			from Linkar_Functions_Persistent_TABLE.Linkar.Functions.Persistent.TABLE.LinkarClient import LinkarClient
			def MyLkSchemas():
				try:
					client = LinkarClient()
	...
	def LkSchemas(self, lkSchemasOptions=LinkarFunctions.LkSchemasOptions(), customVars="", receiveTimeout=0):
		return self.linkarClient.LkSchemas(lkSchemasOptions, LinkarFunctions.DATAFORMATSCH_TYPE.TABLE, customVars, receiveTimeout)
	...
	def LkProperties(self, filename, lkPropertiesOptions=LinkarFunctions.LkPropertiesOptions(), customVars="", receiveTimeout=0):
		return self.linkarClient.LkProperties(filename, lkPropertiesOptions, LinkarFunctions.DATAFORMATSCH_TYPE.TABLE, customVars, receiveTimeout)
	...
	def GetTable(self, filename, selectClause="", dictClause="", sortClause="", tableOptions=LinkarFunctions.TableOptions(), customVars="", receiveTimeout=0):
		return self.linkarClient.GetTable(filename, selectClause, dictClause, sortClause, tableOptions, customVars, receiveTimeout)
