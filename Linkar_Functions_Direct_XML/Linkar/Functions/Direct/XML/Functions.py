...
class Functions:
	...
	"""
		...
		--- Code
			...
			from Linkar_Functions_Direct_XML.Linkar.Functions.Direct.XML.Functions import Functions as DirectFunctions
			def MyRead():
				try:
					credentials = CredentialOptions("127.0.0.1", "EPNAME", 11300, "admin", "admin")
					result = DirectFunctions.Read(credentials, "LK.CUSTOMERS",
									(
	...
	"""
	@staticmethod
	def Read(credentialOptions, filename, recordIds, dictionaries="", readOptions=  LinkarFunctions.ReadOptions(), xmlFormat = XML_FORMAT.XML, customVars="", receiveTimeout=0):
		return DirectFunctions.Read(credentialOptions,filename, recordIds, dictionaries, readOptions, LinkarFunctions.DATAFORMAT_TYPE.XML, xmlFormat, customVars, receiveTimeout)
	...
	"""
	@staticmethod
	def Update(credentialOptions, filename, records, updateOptions=LinkarFunctions.UpdateOptions(), xmlFormat = XML_FORMAT.XML, customVars="", receiveTimeout=0):
		return DirectFunctions.Update(credentialOptions, filename, records, updateOptions, LinkarFunctions.DATAFORMAT_TYPE.XML, xmlFormat, customVars, receiveTimeout)
	...
	"""
	@staticmethod
	def UpdatePartial(credentialOptions, filename, records, dictionaries, updateOptions=LinkarFunctions.UpdateOptions(), xmlFormat = XML_FORMAT.XML, customVars="", receiveTimeout=0):
		return DirectFunctions.UpdatePartial(credentialOptions, filename, records, dictionaries, updateOptions, LinkarFunctions.DATAFORMAT_TYPE.XML, xmlFormat, customVars, receiveTimeout)
	...
	"""
	@staticmethod
	def New(credentialOptions, filename, records, newOptions=LinkarFunctions.NewOptions(), xmlFormat = XML_FORMAT.XML, customVars="", receiveTimeout=0):
		return DirectFunctions.New(credentialOptions, filename, records, newOptions, LinkarFunctions.DATAFORMAT_TYPE.XML, xmlFormat, customVars, receiveTimeout)
	...
	def Delete(credentialOptions, filename, records, deleteOptions=LinkarFunctions.DeleteOptions(), customVars="", receiveTimeout=0):
		return DirectFunctions.Delete(credentialOptions, filename, records, deleteOptions, LinkarFunctions.DATAFORMAT_TYPE.XML, LinkarFunctions.DATAFORMAT_TYPE.XML, customVars, receiveTimeout)
	...
	"""
	@staticmethod
	def Select(credentialOptions, filename, selectClause="", sortClause="", dictClause="", preSelectClause="", selectOptions=LinkarFunctions.SelectOptions(), xmlFormat = XML_FORMAT.XML, customVars="", receiveTimeout=0):
		return DirectFunctions.Select(credentialOptions, filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions, xmlFormat, customVars, receiveTimeout)
	...
	"""
	@staticmethod
	def Subroutine(credentialOptions, subroutineName, argsNumber, args, xmlFormat = XML_FORMAT.XML, customVars="", receiveTimeout=0):
		return DirectFunctions.Subroutine(credentialOptions, subroutineName, argsNumber, args, LinkarFunctions.DATAFORMAT_TYPE.XML, xmlFormat, customVars, receiveTimeout)
	...
	def Conversion(credentialOptions, conversionType, expression, code, customVars="", receiveTimeout=0):
		return DirectFunctions.Conversion(credentialOptions, conversionType, expression, code, LinkarFunctions.DATAFORMAT_TYPE.XML, customVars, receiveTimeout )
	...
	def Format(credentialOptions, expression, formatSpec, customVars="", receiveTimeout=0):
		return DirectFunctions.Format(credentialOptions, expression, formatSpec, LinkarFunctions.DATAFORMAT_TYPE.XML, customVars, receiveTimeout)
	...
	def Dictionaries(credentialOptions, filename, customVars="", receiveTimeout=0):
		return DirectFunctions.Dictionaries(credentialOptions, filename, LinkarFunctions.DATAFORMAT_TYPE.XML, customVars, receiveTimeout)
	...
	def Execute(credentialOptions, statement, customVars="", receiveTimeout=0):
		return DirectFunctions.Execute(credentialOptions, statement, LinkarFunctions.DATAFORMAT_TYPE.XML, customVars, receiveTimeout)
	...
	def GetVersion(credentialOptions, receiveTimeout=0):
		return DirectFunctions.GetVersion(credentialOptions, LinkarFunctions.DATAFORMAT_TYPE.XML, receiveTimeout)
	...
	def LkSchemas(credentialOptions, lkSchemasOptions=LinkarFunctions.LkSchemasOptions(), customVars="", receiveTimeout=0):
		return DirectFunctions.LkSchemas(credentialOptions, lkSchemasOptions, LinkarFunctions.DATAFORMATSCH_TYPE.XML, customVars, receiveTimeout)
	...
	def ResetCommonBlocks(credentialOptions, receiveTimeout=0):
		return DirectFunctions.ResetCommonBlocks(credentialOptions, LinkarFunctions.DATAFORMAT_TYPE.XML, receiveTimeout)
