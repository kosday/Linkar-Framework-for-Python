...
class LinkarClient:
	...
	"""
		...
		---
	"""
	def Read(self, filename, recordIds, dictionaries="", readOptions=LinkarFunctions.ReadOptions(), customVars="", receiveTimeout=0):
		return self.linkarClient.Read(filename, recordIds, dictionaries, readOptions, LinkarFunctions.DATAFORMAT_TYPE.MV, LinkarFunctions.DATAFORMATCRU_TYPE.MV, customVars, receiveTimeout)
	...
	"""
		...
		---
	"""
	def Update(self, filename, records, updateOptions=LinkarFunctions.UpdateOptions(), customVars="", receiveTimeout=0):
		return self.linkarClient.Update(filename, records, updateOptions, LinkarFunctions.DATAFORMAT_TYPE.MV, LinkarFunctions.DATAFORMATCRU_TYPE.MV, customVars, receiveTimeout)
	...
	"""
		...
		---
	"""
	def UpdatePartial(self, filename, records, dictionaries, updateOptions=LinkarFunctions.UpdateOptions(), customVars="", receiveTimeout=0):
		return self.linkarClient.UpdatePartial(filename, records, dictionaries, updateOptions, LinkarFunctions.DATAFORMATCRU_TYPE.MV, LinkarFunctions.DATAFORMATCRU_TYPE.MV, customVars, receiveTimeout)
	...
	"""
			...
			def MyNew():
				try:
					...
					result = client.New("LK.CUSTOMERS",
										"222" + LinkarFunctions.ASCII_Chars.FS_chr +	# RecordId
		...
		---
	"""
	def New(self, filename, records, newOptions=LinkarFunctions.NewOptions(), customVars="", receiveTimeout=0):
		return self.linkarClient.New(filename, records, newOptions, LinkarFunctions.DATAFORMAT_TYPE.MV, LinkarFunctions.DATAFORMATCRU_TYPE.MV, customVars, receiveTimeout)
	...
	def Delete(self, filename, records, deleteOptions=LinkarFunctions.DeleteOptions(), customVars="", receiveTimeout=0):
		return self.linkarClient.Delete(filename, records, deleteOptions, LinkarFunctions.DATAFORMAT_TYPE.MV, LinkarFunctions.DATAFORMAT_TYPE.MV, customVars, receiveTimeout)
	...
	"""
		...
		---
	"""
	def Select(self, filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions=LinkarFunctions.SelectOptions(), customVars="", receiveTimeout=0):
		return self.linkarClient.Select(filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions, LinkarFunctions.DATAFORMATCRU_TYPE.MV, customVars, receiveTimeout)
	...
	def Subroutine(self, subroutineName, argsNumber, args, customVars="", receiveTimeout=0):
		return self.linkarClient.Subroutine(subroutineName, argsNumber, args, LinkarFunctions.DATAFORMAT_TYPE.MV, LinkarFunctions.DATAFORMAT_TYPE.MV, customVars, receiveTimeout)
	...
	def Conversion(self, conversionType, expression, code, customVars="", receiveTimeout=0):
		return self.linkarClient.Conversion(conversionType, expression, code, LinkarFunctions.DATAFORMAT_TYPE.MV, customVars, receiveTimeout)
	...
	def Format(self, expression, formatSpec, customVars="", receiveTimeout=0):
		return self.linkarClient.Format(expression, formatSpec, LinkarFunctions.DATAFORMAT_TYPE.MV, customVars, receiveTimeout)
	...
	def Dictionaries(self, filename, customVars="", receiveTimeout=0):
		return self.linkarClient.Dictionaries(filename, LinkarFunctions.DATAFORMAT_TYPE.MV, customVars, receiveTimeout)
	...
	def Execute(self, statement, customVars="", receiveTimeout=0):
		return self.linkarClient.Execute(statement, LinkarFunctions.DATAFORMAT_TYPE.MV, customVars, receiveTimeout)
	...
	def GetVersion(self, receiveTimeout=0):
		return self.linkarClient.GetVersion(LinkarFunctions.DATAFORMAT_TYPE.MV, receiveTimeout)
	...
	def LkSchemas(self, lkSchemasOptions=LinkarFunctions.LkSchemasOptions(), customVars="", receiveTimeout=0):
		return self.linkarClient.LkSchemas(lkSchemasOptions, LinkarFunctions.DATAFORMAT_TYPE.MV, customVars, receiveTimeout)
	...
	def LkProperties(self, filename, lkPropertiesOptions=LinkarFunctions.LkPropertiesOptions(), customVars="", receiveTimeout=0):
		return self.linkarClient.LkProperties(filename, lkPropertiesOptions, LinkarFunctions.DATAFORMAT_TYPE.MV, customVars, receiveTimeout)
	...
	def ResetCommonBlocks(self, receiveTimeout=0):
		return self.linkarClient.ResetCommonBlocks(LinkarFunctions.DATAFORMAT_TYPE.MV, receiveTimeout)