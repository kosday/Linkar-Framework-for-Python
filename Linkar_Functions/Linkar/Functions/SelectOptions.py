...
class SelectOptions:
	...
	"""
	def GetString(self):
		return ("1" if self.Pagination else "0") + DBMV_Mark.VM_str + str(self.Pagination_RegPage) + DBMV_Mark.VM_str + str(self.Pagination_NumPage) + DBMV_Mark.AM_str + ("1" if self.OnlyRecordId else "0") + DBMV_Mark.AM + self.CommonOptions.GetStringAM()
