...
class CommonOptions:
	...
	def GetStringAM(self):
		return	("1" if self.Calculated else "0") + DBMV_Mark.AM_str + "" + DBMV_Mark.AM_str + ("1" if self.Conversion else "0") + DBMV_Mark.AM_str + ("1" if self.FormatSpec else "0") + DBMV_Mark.AM_str + ("1" if self.OriginalRecords else "0")
