...
class DirectFunctions:
	...
	"""
	@staticmethod
	def Conversion(credentialOptions, expression, code, conversionType,	outputFormat=LinkarFunctions.DATAFORMAT_TYPE.MV, customVars="", receiveTimeout=0):
		opArgs = OperationArguments.OperationArguments.GetConversionArgs(expression, code, conversionType, customVars)        
	...
	"""
	@staticmethod
	def LkProperties(credentialOptions, filename, lkPropertiesOptions=LinkarFunctions.LkPropertiesOptions(), outputFormat=LinkarFunctions.DATAFORMATSCH_TYPE.MV, customVars="", receiveTimeout=0):
