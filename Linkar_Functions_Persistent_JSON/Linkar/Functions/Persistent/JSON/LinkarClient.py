...
class LinkarClient:
	...
	"""
		...
		--- Code
			...
			from Linkar_Functions_Persistent_JSON.Linkar.Functions.Persistent.JSON.LinkarClient import LinkarClient
			def MyRead():
				try:
					client = LinkarClient()
		...
		---
	"""
	def Read(self, filename, recordIds, dictionaries="", readOptions=LinkarFunctions.ReadOptions(), jsonFormat = JSON_FORMAT.JSON, customVars="", receiveTimeout=0):
		return self.linkarClient.Read(filename, recordIds, dictionaries, readOptions, LinkarFunctions.DATAFORMAT_TYPE.JSON, jsonFormat, customVars, receiveTimeout)
	...
	"""
		...
		---
	"""
	def Update(self, filename, records, updateOptions=LinkarFunctions.UpdateOptions(), jsonFormat = JSON_FORMAT.JSON, customVars="", receiveTimeout=0):
		return self.linkarClient.Update(filename, records, updateOptions, LinkarFunctions.DATAFORMAT_TYPE.JSON, jsonFormat, customVars, receiveTimeout)
	...
	"""
		...
		---
	"""
	def UpdatePartial(self, filename, records, dictionaries, updateOptions=LinkarFunctions.UpdateOptions(), jsonFormat = JSON_FORMAT.JSON, customVars="", receiveTimeout=0):
		return self.linkarClient.UpdatePartial(filename, records, dictionaries, updateOptions, LinkarFunctions.DATAFORMAT_TYPE.JSON, jsonFormat, customVars, receiveTimeout)
	...
	"""
		...
		---
	"""
	def New(self, filename, records, newOptions=LinkarFunctions.NewOptions(), jsonFormat = JSON_FORMAT.JSON, customVars="", receiveTimeout=0):
		return self.linkarClient.New(filename, records, newOptions, LinkarFunctions.DATAFORMAT_TYPE.JSON, jsonFormat, customVars, receiveTimeout)
	...
	def Delete(self, filename, records, deleteOptions=LinkarFunctions.DeleteOptions(), customVars="", receiveTimeout=0):
		return self.linkarClient.Delete(filename, records, deleteOptions, LinkarFunctions.DATAFORMAT_TYPE.JSON, LinkarFunctions.DATAFORMAT_TYPE.JSON, customVars, receiveTimeout)
	...
	"""
		...
		---
	"""
	def Select(self, filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions=LinkarFunctions.SelectOptions(), jsonFormat = JSON_FORMAT.JSON, customVars="", receiveTimeout=0):
		return self.linkarClient.Select(filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions, jsonFormat, customVars, receiveTimeout)
	...
	def Subroutine(self, subroutineName, argsNumber, args, customVars="", receiveTimeout=0):
		return self.linkarClient.Subroutine(subroutineName, argsNumber, args, LinkarFunctions.DATAFORMAT_TYPE.JSON, LinkarFunctions.DATAFORMAT_TYPE.JSON, customVars, receiveTimeout)
	...
	def Conversion(self, conversionType, expression, code, customVars="", receiveTimeout=0):
		return self.linkarClient.Conversion(expression, code, conversionType, LinkarFunctions.DATAFORMAT_TYPE.JSON, customVars, receiveTimeout)
	...
	def Format(self, expression, formatSpec, customVars="", receiveTimeout=0):
		return self.linkarClient.Format(expression, formatSpec, LinkarFunctions.DATAFORMAT_TYPE.JSON, customVars, receiveTimeout)
	...
	def Dictionaries(self, filename, customVars="", receiveTimeout=0):
		return self.linkarClient.Dictionaries(filename, LinkarFunctions.DATAFORMAT_TYPE.JSON, customVars, receiveTimeout)
	...
	def Execute(self, statement, customVars="", receiveTimeout=0):
		return self.linkarClient.Execute(statement, LinkarFunctions.DATAFORMAT_TYPE.JSON, customVars, receiveTimeout)
	...
	def GetVersion(self, receiveTimeout=0):
		return self.linkarClient.GetVersion(LinkarFunctions.DATAFORMAT_TYPE.JSON, receiveTimeout)
	...
	def LkSchemas(self, lkSchemasOptions=LinkarFunctions.LkSchemasOptions(), customVars="", receiveTimeout=0):
		return self.linkarClient.LkSchemas(lkSchemasOptions, LinkarFunctions.DATAFORMATSCH_TYPE.JSON, customVars, receiveTimeout)
	...
	"""
		...
		---
	"""
	def LkProperties(self, filename, lkPropertiesOptions=LinkarFunctions.LkPropertiesOptions(), customVars="", receiveTimeout=0):
		return self.linkarClient.LkProperties(filename, lkPropertiesOptions, LinkarFunctions.DATAFORMATSCH_TYPE.JSON, customVars, receiveTimeout)
	...
	def ResetCommonBlocks(self, receiveTimeout=0):
		return self.linkarClient.ResetCommonBlocks(LinkarFunctions.DATAFORMAT_TYPE.JSON, receiveTimeout)