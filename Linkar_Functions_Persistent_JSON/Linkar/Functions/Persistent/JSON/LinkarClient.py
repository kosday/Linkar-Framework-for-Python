...
class LinkarClient:
	...
	"""
		...
		---
	"""
	def LkProperties(self, filename, lkPropertiesOptions=LinkarFunctions.LkPropertiesOptions(), jsonFormat=JSON_FORMAT.JSON, customVars="", receiveTimeout=0):
		return self.linkarClient.LkProperties(filename, lkPropertiesOptions, jsonFormat, customVars, receiveTimeout)
